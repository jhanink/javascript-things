...
* `delete` operator
   ...
   * note: `delete` can [hurt v8 optimizations](https://github.com/petkaantonov/bluebird/wiki/Optimization-killers#521-objects-that-are-in-hash-table-mode-aka-normalized-objects-dictionary-mode---objects-who-have-a-hash-table-as-a-backing-data-structure-are-not-simple-enumerables)
* void operator
   * `void(0)`
* spread operator
